#!/usr/bin/env python
"""
Standalone test script for SimpleOCR model.
Usage: python test_simple_ocr.py <path_to_image> [--mode general|handwriting|table]
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test SimpleOCR Model")
    ...
    print(f"Initializing SimpleOCR...")
    ocr = SimpleOCR(languages=['eng'], debug_mode=args.debug)
